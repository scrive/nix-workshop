...
# Getting Started
  ...
  - [Resources](./01-getting-started/03-resources.md)

# Nix Commands

  - [Installing Global Packages](./02-nix-commands/01-install-global-packages.md)

  - [Using Packages in Nix shell](./02-nix-commands/02-use-packages-in-nix-shell.md)

  - [Nix Repl](./02-nix-commands/03-nix-repl.md)

# Nix Basics

  - [Nix Primitives](./03-nix-basics/01-primitives.md)

  - [Expressions](./03-nix-basics/02-expressions.md)
...
# Derivations
  ...
  - [Derivation Basics](./04-derivations/01-derivation-basics.md)
...
# Infrastructure
  ...
  - [Caching Nix Packages](./06-infrastructure/01-caching-nix.md).

  - [Caching Haskell Nix Packages](./06-infrastructure/02-caching-haskell.md)
